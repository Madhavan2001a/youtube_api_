...
icon = Image.open("C:/Users/Admin/Downloads/youtubelogo.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Madhavan",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Madhavan!*"""})


# Creating the option meny
with st.sidebar:
    ...
    if "youtube_Data" in client.list_database_names():
        print("Database 'youtube_data' exists.")
    else:
        print("Database 'youtube_data' does not exist.")

        # CONNECTING WITH MYSQL DATABASE
        mydb = sql.connect(host="127.0.0.1",
                           user="root",
                           password="maddysql123",
        ...
        api_key = "AIzaSyDPvcRBsi-kf67ZNJMj6TiUPNKWsabZQjU"
        ...
        if selected == "Home":
            # Title Image
            st.image("C:/Users/Admin/Downloads/png-transparent-youtube-computer-icons-youtube-angle-rectangle-black-thumbnail.png")
...
if selected == "Extract & Transform":
    st.markdown(
        ...
        <style>
        .stApp {
            background-image: url('https://images.unsplash.com/photo-1487088678257-3a541e6e3922?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8eW91dHViZSUyMGJhY2tncm91bmR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60');
    ...
    with tab1:
        ...
        ch_id = st.text_input(
            "Hint : Go to channel's home page > Right click > View page source > ctrlF > Type channel id ").split(',')
